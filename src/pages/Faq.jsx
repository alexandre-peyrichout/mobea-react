...
export default function PaperSheet() {
  ...
  return (
    ...
    <Paper className={classes.root}>
      ...
      <p className={classes.contenu}>
        Mobea couvre les iphones avec IOS et les téléphones Android aussi.</p>
      <Typography className={classes.subtitle} color="primary" variant="h6">
      ...
      <p className={classes.contenu}>
        Rien de plus simple : contact@mobea.co</p>
      <Typography className={classes.subtitle} color="primary" variant="h6">
      ...
      <p className={classes.contenu}>
        Aucune limite, alors invitez-en le plus grand nombre !</p>
      <Typography className={classes.subtitle} color="primary" variant="h6">
      Comment faire pour obtenir d’avance d’aide ?
      </Typography>
      <p className={classes.contenu}>
        N’hésitez surtout pas à nous contacter par mail sur : contact@mobea.co pour toute demande d’aide, retours d’utilisations ou autres remarques pour continuer d’améliorer le service.</p>
