    ...
    <Layout>
      <div>
        <Paper className={classes.root}>
          ...
          de vie. Vous verrez apparaitre en fonction de vos besoins, les outils proposés par MOBEA.
          Dès votre inscription, vous pouvez planifier votre ou vos expatriation(s) en simultané sur
          une carte. Plusieurs offres de services sont répertoriées et vous ferez le choix selon
          ...
          de partager vos conseils, retours, avis en temps réel sur un endroit ou un produit/
          service avec votre entourage et les autres utilisateurs ou partager votre passion et/ou
          loisir avec les nouveaux arrivés dans votre ville " Happy expat" et les aider à s'intégrer
          ...
          en renseignant leurs noms ou en les sélectionnant directement depuis vos contacts. Si vous
          désirez en ajouter de nouveaux à postériori, vous le pouvez le faire très simplement
          depuis les paramètres de l'application. Dans le menu de votre profil, cliquer sur "Inviter
          un contact".
          <br />
          <br />
          <Typography className={classes.subtitle} variant="h5">
          ...
          est d'être présent aux quatre coins du monde dès que tu trouveras une once de connexion
          aux données mobile ou un accès à réseau Wifi.
          <br />
          <br />
          <Typography className={classes.subtitle} variant="h5">
          ...
          paramètres de l'application. Si vous le faites pour une toute autre raison que de changer
          de smartphone, nous serions ravis de connaitre les raisons qui vous poussent à le
          supprimer afin d'améliorer sans cesse le service. Cette app est le fruit d’une équipe
          passionnée, entièrement dédiés à rendre votre expatriation simplifiée. Vos remarques sont
          plus qu’appréciées.
          <br />
          <br />
          <Typography className={classes.subtitle} variant="h5">
          ...
          sur votre liste de Happy Expat et glissez avec votre doigt sur le prénom que vous
          souhaitez supprimer de la gauche vers la droite.
          <br />
          <br />
          <Typography className={classes.subtitle} variant="h5">
